...
try {
  ...
  const expectedFiles = [
    ...
    "dist/src/node/approved-source-manifest.d.ts",
    "dist/src/node/approved-source-manifest.js",
    ...
    "dist/src/trusted-sources/livebench-discovery.d.ts",
    "dist/src/trusted-sources/livebench-discovery.js",
    "dist/src/trusted-sources/manifest.d.ts",
    "dist/src/trusted-sources/manifest.js",
    "dist/src/sources/livebench.d.ts",
    "dist/src/sources/livebench.js",
    "dist/src/sources/openrouter-models-parser.d.ts",
    "dist/src/sources/openrouter-models-parser.js",
    "dist/src/sources/openrouter-models.d.ts",
    "dist/src/sources/openrouter-models.js",
    "dist/src/types.d.ts",
    "dist/src/types.js",
    "dist/src/validate.d.ts",
    "dist/src/validate.js",
    "package.json",
    "sources/approved-sources.v1.json",
  ].sort();
  ...
  await execFileAsync(
    ...
    [
      ...
      [
        ...
        'if (typeof core.parseApprovedSourceManifest !== "function") throw new Error("missing parseApprovedSourceManifest");',
        'if (typeof core.resolveLiveBenchDiscovery !== "function") throw new Error("missing resolveLiveBenchDiscovery");',
        ...
        'const manifest = await adapter.loadPackagedApprovedSourceManifest();',
        'if (!manifest.sources.some((source) => source.id === "livebench")) throw new Error("missing packaged LiveBench source");',
        'if (!manifest.sources.some((source) => source.id === "openrouter-models")) throw new Error("missing packaged OpenRouter source");',
      ].join("\n"),
    ],
    { cwd: consumer },
  );
